/* ==========================================================================
   ...
   Sections:
     ...
     4. Scroll-reveal enhancement     (all pages, progressive/optional)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ------------------------------------------------------------------
     4. SCROLL-REVEAL ENHANCEMENT
     Purely additive: fades/lifts .reveal elements into place as they
     enter the viewport. Falls back gracefully if IntersectionObserver
     isn't supported, and does nothing if the person prefers reduced
     motion (handled primarily in CSS, but skipped here too for safety).
  ------------------------------------------------------------------ */
